...
export const FINGERPRINT_INJECT_CODE = [
  ...
  '    var _majorVer = _chromeMatch ? _chromeMatch[1] : "136";',
  '    var _brands = [',
  ...
  '        if (hints.indexOf("uaFullVersion") !== -1) result.uaFullVersion = _majorVer + ".0.0.0";',
  '        if (hints.indexOf("fullVersionList") !== -1) result.fullVersionList = _brands;',
